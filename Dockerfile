...
# Checkout ComfyUI release version 0.13.0
RUN git fetch --unshallow && git checkout 6648ab68bc934a185c90a2a872c87dc64d093751
...
# Labels
LABEL org.opencontainers.image.title="Base image ComfyUI 0.13.0 + code-server + downloaders" \
