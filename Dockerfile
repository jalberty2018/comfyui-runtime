...
# Checkout ComfyUI release version 0.14.0
RUN git fetch --unshallow && git checkout fe52843fe55b92dedaabff684294dd7a115d2204
...
# Labels
LABEL org.opencontainers.image.title="Base image ComfyUI 0.14.0 + code-server + downloaders" \
