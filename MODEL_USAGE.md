...
comfyui-runtime is a ComfyUI base image. This repository provides no start.sh
and defines no service startup or automatic model-download workflow. Its
Dockerfile installs runtime software; the GitHub release artifacts downloaded
during the build are software wheels, not models.
...
software already included in the base image; see LICENSING.md and
